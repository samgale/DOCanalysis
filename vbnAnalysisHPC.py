...
def findBestFit(jobInd,totalJobs):
    ...
    # fine tune mouse
    # tauIRange = np.arange(0.5,1,0.1)
    # alphaRange = np.arange(0.07,0.14,0.01)
    # etaRange = [1]
    # sigmaRange = np.arange(0.85,0.96,0.01)
    # tauARange = np.arange(3.5,4.6,0.1)
    # decayRange = np.arange(0.85,0.96,0.01)
    # inhibRange = np.arange(0.75,0.86,0.01)
    # thresholdRange = np.arange(1.05,1.16,0.01)
    # trialEndRange = [trialEnd]
    # postDecisionRange = np.arange(15.5,16.6,0.1)
